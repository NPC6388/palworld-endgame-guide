...
- **Weapon cost scales with schematic rarity** — but you craft each weapon once, so it matters little. **Ammo is the recurring bill**, and ammo is tech-unlocked, so its cost is fixed.
- **The Mechanical Bow does 20,000 Attack** — over 10× the Plasma Rifle (1,860) and Heavy Assault Rifle (1,615) — at 0.4 Soralite per round and zero Paloxite. Confirmed in-game at Common rarity. Attack is per-shot, not DPS, but on materials it is not close.
