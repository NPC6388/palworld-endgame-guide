...
- **The Beam Launcher is the best Paloxite spend** — 14,000 Attack vs the Plasma Rifle’s 1,860 means 11,667 damage per Paloxite against 6,200. (An earlier version of this guide said the reverse; it compared cost per *round* without comparing damage.)
- **Ammo is the recurring bill** — weapons are one-offs. Every endgame ammo recipe is now confirmed from in-game panels.
