...
- **There are no per-job passives.** Work-speed passives apply to all twelve jobs equally — and to ranch output too — so one worker template covers every base Pal you will ever breed, up to **+245% Work Speed**. Three templates cover the whole game: worker, combat, mount.
