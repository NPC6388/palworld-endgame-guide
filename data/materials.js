...
const MATERIALS = [
  ...
  },
  {
    ...
    party: "<strong>Crystals despawn on proximity without the Holy Water buff — and your <em>Pal’s</em> proximity triggers it too</strong>, so a Pal running ahead can wipe the node. Window is <strong>30–60s</strong>. Better: <strong>any</strong> Pal carrying <strong>any World Tree passive</strong> stops them despawning — <strong>permanent</strong> protection, a property of the whole tier rather than one skill. Plasma Multicutter mandatory (and doubles yield). Bring <strong>Dandilord</strong> for toxic gas and <strong>Lunaris</strong> for weight.",
    conf: "High"
  },
  {
